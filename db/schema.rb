...
ActiveRecord::Schema.define(version: 2021_04_22_090440) do
  ...
  create_table "information", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.index ["item_user_id"], name: "index_information_on_item_user_id"
  end
  ...
  add_foreign_key "information", "item_users"
